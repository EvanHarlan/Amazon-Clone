...
const NavBar = () => {
  ...
  return (
    <header className="min-w-[1000px]">
            ...
            <div className="pr-4 pl-4">
                ...
                <div className="flex pr-3 pl-3">
                    ...
                    <div className="relative">
                        <div className="absolute right-[9px] font-boold m-2 text-orange-400">
                            {cart}
                        </div>
                    </div>
        ...
        <div className="flex bg-amazonclone-lightblue text-white space-x-3 text-xs xl:text-sm p-2 pl-6">
